/******************************
  Program "MSI_MSI_MSI_detailed.m" compiled by "Caching Murphi Release 5.4.9"
...
#define PROTOCOL_NAME "MSI_MSI_MSI_detailed"
#define BITS_IN_WORLD 12547
#define HASHC
...
class mu_1_C1Machines: public mu__byte
{
 public:
  ...
  int value() const
  {
    ...
    if (val == -1) return -1;
    if (val <= 0) return val+131;
    if (val <= 2) return val+131;
    if (val <= 4) return val+131;
    if (val <= 5) return val+131;
    if (val <= 6) return val+131;
  }
  inline int value(int val)
  {
    if (val == -1) { undefine(); return -1; }
    if ((val >= 131) && (val <= 131)) return (mu__byte::value(val-131)+131);
    if ((val >= 132) && (val <= 133)) return (mu__byte::value(val-131)+131);
    if ((val >= 134) && (val <= 135)) return (mu__byte::value(val-131)+131);
    if ((val >= 136) && (val <= 136)) return (mu__byte::value(val-131)+131);
    if ((val >= 137) && (val <= 137)) return (mu__byte::value(val-131)+131);
  }
...
void mu_1_Message::set_self(const char *n, int os)
{
  ...
  if (name) mu_acksRequiredL2.set_self_2(name, ".acksRequiredL2", os + 21 ); else mu_acksRequiredL2.set_self_2(NULL, NULL, 0);
}
...
if (n) array[i].set_self_ar(n,"directoryL2", i * 576 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1_2_1", i * 576 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1_2_2", i * 576 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1_1_1", i * 576 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1_1_2", i * 576 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"directoryL1_1", i * 576 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"directoryL1_2", i * 576 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"directoryL2", i * 624 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1_2_1", i * 624 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1_2_2", i * 624 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1_1_1", i * 624 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1_1_2", i * 624 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"directoryL1_1", i * 624 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"directoryL1_2", i * 624 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
void mu_1_ENTRY_directoryL2::set_self(const char *n, int os)
{
  ...
  if (name) mu_ownerL2.set_self_2(name, ".ownerL2", os + 20 ); else mu_ownerL2.set_self_2(NULL, NULL, 0);
}
...
if (n) array[i].set_self_ar(n,"Address_1", i * 23 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"directoryL2", i * 23 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
  }
...
void mu_1_ENTRY_directoryL1_1::set_self(const char *n, int os)
{
  ...
  if (name) mu_sharersL1_1.set_self_2(name, ".sharersL1_1", os + 7 ); else mu_sharersL1_1.set_self_2(NULL, NULL, 0);
  if (name) mu_ownerL1_1.set_self_2(name, ".ownerL1_1", os + 22 ); else mu_ownerL1_1.set_self_2(NULL, NULL, 0);
  if (name) mu_acksReceivedL1_1.set_self_2(name, ".acksReceivedL1_1", os + 25 ); else mu_acksReceivedL1_1.set_self_2(NULL, NULL, 0);
  if (name) mu_acksExpectedL1_1.set_self_2(name, ".acksExpectedL1_1", os + 28 ); else mu_acksExpectedL1_1.set_self_2(NULL, NULL, 0);
  if (name) mu_acksReceivedL2.set_self_2(name, ".acksReceivedL2", os + 31 ); else mu_acksReceivedL2.set_self_2(NULL, NULL, 0);
  if (name) mu_acksExpectedL2.set_self_2(name, ".acksExpectedL2", os + 34 ); else mu_acksExpectedL2.set_self_2(NULL, NULL, 0);
  if (name) mu_invalidation_msg.set_self_2(name, ".invalidation_msg", os + 37 ); else mu_invalidation_msg.set_self_2(NULL, NULL, 0);
  if (name) mu_cluster_req_msg.set_self_2(name, ".cluster_req_msg", os + 61 ); else mu_cluster_req_msg.set_self_2(NULL, NULL, 0);
}
...
if (n) array[i].set_self_ar(n,"Address_1", i * 85 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"directoryL1_1", i * 85 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
  }
...
void mu_1_ENTRY_directoryL1_2::set_self(const char *n, int os)
{
  ...
  if (name) mu_State.set_self_2(name, ".State", os + 0 ); else mu_State.set_self_2(NULL, NULL, 0);
  if (name) mu_cl.set_self_2(name, ".cl", os + 5 ); else mu_cl.set_self_2(NULL, NULL, 0);
  if (name) mu_sharersL1_2.set_self_2(name, ".sharersL1_2", os + 7 ); else mu_sharersL1_2.set_self_2(NULL, NULL, 0);
  if (name) mu_ownerL1_2.set_self_2(name, ".ownerL1_2", os + 22 ); else mu_ownerL1_2.set_self_2(NULL, NULL, 0);
  if (name) mu_acksReceivedL1_2.set_self_2(name, ".acksReceivedL1_2", os + 25 ); else mu_acksReceivedL1_2.set_self_2(NULL, NULL, 0);
  if (name) mu_acksExpectedL1_2.set_self_2(name, ".acksExpectedL1_2", os + 28 ); else mu_acksExpectedL1_2.set_self_2(NULL, NULL, 0);
  if (name) mu_acksReceivedL2.set_self_2(name, ".acksReceivedL2", os + 31 ); else mu_acksReceivedL2.set_self_2(NULL, NULL, 0);
  if (name) mu_acksExpectedL2.set_self_2(name, ".acksExpectedL2", os + 34 ); else mu_acksExpectedL2.set_self_2(NULL, NULL, 0);
  if (name) mu_invalidation_msg.set_self_2(name, ".invalidation_msg", os + 37 ); else mu_invalidation_msg.set_self_2(NULL, NULL, 0);
  if (name) mu_cluster_req_msg.set_self_2(name, ".cluster_req_msg", os + 61 ); else mu_cluster_req_msg.set_self_2(NULL, NULL, 0);
...
if (n) array[i].set_self_ar(n,"directoryL1_2", i * 85 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
  }
...
/*** Variable declaration ***/
mu_1_NET_Ordered_cnt mu_cnt_fwd("cnt_fwd",4032);

/*** Variable declaration ***/
mu_1_NET_Ordered mu_resp("resp",4067);

/*** Variable declaration ***/
mu_1_NET_Ordered_cnt mu_cnt_resp("cnt_resp",8099);

/*** Variable declaration ***/
mu_1_NET_Ordered mu_req("req",8134);

/*** Variable declaration ***/
mu_1_NET_Ordered_cnt mu_cnt_req("cnt_req",12166);

/*** Variable declaration ***/
mu_1_PermMonitor mu_g_perm("g_perm",12201);

/*** Variable declaration ***/
mu_1_OBJ_directoryL2 mu_i_directoryL2("i_directoryL2",12306);

/*** Variable declaration ***/
mu_1_OBJ_cacheL1_2 mu_i_cacheL1_2("i_cacheL1_2",12329);

/*** Variable declaration ***/
mu_1_OBJ_cacheL1_1 mu_i_cacheL1_1("i_cacheL1_1",12353);

/*** Variable declaration ***/
mu_1_OBJ_directoryL1_1 mu_i_directoryL1_1("i_directoryL1_1",12377);

/*** Variable declaration ***/
mu_1_OBJ_directoryL1_2 mu_i_directoryL1_2("i_directoryL1_2",12462);
...
cout << "SS_MSG:  ";
mu_Message.mu_mtype.print();
cout << "  SRC: ";
mu_Message.mu_src.print();
cout << "  DEST: ";
mu_Message.mu_dst.print();
cout << "\n";
return mu_Message;
