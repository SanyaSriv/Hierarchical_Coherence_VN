...
case cache_I:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_I"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
   else return false;
endswitch;

case cache_I_load:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_I_load"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case GetS_Ack:
    cle.cl := inmsg.cl;
    cle.State := cache_S;
...
case cache_I_store:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_I_store"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case GetM_Ack_AD:
...
case cache_I_store_GetM_Ack_AD:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_I_store_GetM_Ack_AD"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case Inv_Ack:
    cle.acksReceived := cle.acksReceived+1;
    if (cle.acksExpected=cle.acksReceived) then
...
case cache_M:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_M"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case Fwd_GetM_M:
...
case cache_M_evict:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_M_evict"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case Fwd_GetM_M:
    msg := RespData(adr,GetM_Ack_D,m,inmsg.src,cle.cl);
    Send_resp(msg);
...
case cache_M_evict_Fwd_GetM_M:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_M_evict_Fwd_GetM_M"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case Fwd_GetM_O:
...
case cache_O:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_O"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case Fwd_GetM_O:
    msg := RespDataAck(adr,GetM_Ack_AD,m,inmsg.src,cle.cl,inmsg.acksExpected);
    Send_resp(msg);
...
case cache_O_store:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_O_store"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case Fwd_GetM_O:
    msg := RespDataAck(adr,GetM_Ack_AD,m,inmsg.src,cle.cl,inmsg.acksExpected);
    Send_resp(msg);
...
case cache_O_store_GetM_Ack_AD:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_O_store_GetM_Ack_AD"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case Inv_Ack:
    cle.acksReceived := cle.acksReceived+1;
    if (cle.acksExpected=cle.acksReceived) then
...
case cache_S:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_S"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case Inv:
    msg := Ack(adr,Inv_Ack,m,inmsg.src);
    Send_resp(msg);
...
case cache_S_evict:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: cache_S_evict"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case Inv:
    msg := Ack(adr,Inv_Ack,m,inmsg.src);
    Send_resp(msg);
...
case directory_I:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: directory_I"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case GetM:
    msg := RespData(adr,GetM_Ack_D,m,inmsg.src,cle.cl);
    Send_resp(msg);
...
case directory_M:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: directory_M"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case GetM:
...
case directory_O:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: directory_O"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case GetM:
    RemoveElement_v_NrCaches_OBJSET_cache(cle.cache,inmsg.src);
    if (cle.owner=inmsg.src) then
...
case directory_S:
				put "SS_PRINT:  "; put inmsg.mtype; put "  CASE: directory_S"; put "\n"; -- Sanya: inserted a print here
switch inmsg.mtype
  case GetM:
