/******************************
  Program "put_MOSI.m" compiled by "Caching Murphi Release 5.4.9"
...
cout << "SS_PRINT:  ";
cout << ( mu_inmsg.mu_mtype );
cout << "  CASE: cache_I_store_GetM_Ack_AD";
cout << "\n";
switch ((int) mu_inmsg.mu_mtype) {
case mu_Inv_Ack:
mu_cle.mu_acksReceived = (mu_cle.mu_acksReceived) + (1);
...
cout << "SS_PRINT:  ";
cout << ( mu_inmsg.mu_mtype );
cout << "  CASE: cache_M_evict_Fwd_GetM_M";
cout << "\n";
switch ((int) mu_inmsg.mu_mtype) {
case mu_Fwd_GetM_O:
...
cout << "SS_PRINT:  ";
cout << ( mu_inmsg.mu_mtype );
cout << "  CASE: cache_O_store_GetM_Ack_AD";
cout << "\n";
switch ((int) mu_inmsg.mu_mtype) {
case mu_Inv_Ack:
mu_cle.mu_acksReceived = (mu_cle.mu_acksReceived) + (1);
