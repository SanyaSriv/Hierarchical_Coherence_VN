/******************************
  Program "n_peterson.m" compiled by "Caching Murphi Release 5.4.9"
...
class mu_1_pid: public mu__byte
{
 public:
  ...
  mu_1_pid (const char *name, int os): mu__byte(1, 7, 3, name, os) {};
...
class mu_1_priority: public mu__byte
{
 public:
  ...
  mu_1_priority (const char *name, int os): mu__byte(0, 7, 4, name, os) {};
...
class mu_1_label_t: public mu__byte
{
 public:
  ...
  mu_1_label_t (const char *name, int os): mu__byte(8, 12, 3, name, os) {};
...
const char *mu_1_label_t::values[] = {"L0","L1","L2","L3","L4",NULL };
...
if (n) array[i].set_self_ar(n,"pid_1", i * 8 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"pid_2", i * 8 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"pid_3", i * 8 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"pid_4", i * 8 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"pid_5", i * 8 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"pid_6", i * 8 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"pid_7", i * 8 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
/*** Variable declaration ***/
mu_1__type_1 mu_Q("Q",56);

/*** Variable declaration ***/
mu_1__type_2 mu_turn("turn",112);

/*** Variable declaration ***/
mu_1__type_3 mu_localj("localj",176);
...
{"Invariant 0", &mu__condition_12, NULL, },
};
